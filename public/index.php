<?php
    ...
    $routes = [
        ...
        'dashboard/settings'        => ['view' => '/../app/pages/dashboard/settings.php', 'protected' => true],
        'dashboard/reset_password'        => ['view' => '/../app/pages/dashboard/resetPassword.php', 'protected' => true],

...
<html lang="en" >
    <head>
        ...
        <meta name="keywords" content="pbuy, ecommerce, marketplace, online shopping, deals, electronics, fashion, home">
        ...
        <meta property="og:url" content="https://www.pbuy.onrender.com/"> <!-- Replace with your actual URL -->
        <meta property="og:image" content="https://www.pbuy.onrender.com/images/og-image.jpg"> <!-- Replace with your image URL -->
        ...
        <meta name="twitter:image" content="https://www.pbuy.onrender.com/images/og-image.jpg"> <!-- Replace with your image URL -->
    ...
    <body class="bg-gray-100 text-gray-900 flex flex-col min-h-screen">
        ...
        <script src="<?= BASE_PATH ?>js/toast.js"></script>
        <script>
            lucide.createIcons();
        </script>
